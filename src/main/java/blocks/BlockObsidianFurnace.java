...
import me.luckycoder.test.client.gui.GuiHandler;
...
public class BlockObsidianFurnace extends BlockContainer {
	...
	public BlockObsidianFurnace(String unlocalziedName) {
		super(Material.ROCK);
	...
	public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player,
		...
		player.openGui(Test.instance, GuiHandler.OBSIDIAN_FURNACE, world, pos.getX(), pos.getY(), pos.getZ());
		return true;
	}
