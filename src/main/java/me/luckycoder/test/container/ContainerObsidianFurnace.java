package me.luckycoder.test.container;

import me.luckycoder.test.container.slots.SlotFurnaceFuel;
import me.luckycoder.test.container.slots.SlotFurnaceOutput;
...
public class ContainerObsidianFurnace extends Container {
	...
	public ContainerObsidianFurnace(EntityPlayer player, TileEntityObsidianFurnace te) {
		this.te = te;
